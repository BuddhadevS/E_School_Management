...
<h1 style="  position: absolute; left: 570px; top: 10px; 
   border-radius: 10px;
  padding: 5px;
  box-sizing: border-box;
  background: #e5f9d6c7;">
  Welcome Library Admin </h1>
    <nav class="main-menu">
       ...
       <li>                                   
       <a href="http://localhost/e-school%20system/teacher/HomeIndexteacher.php">
       ...
       <li >
       <a href="http://localhost/E-School System\Library\Book Record\index.php">
           <i class="fas fa-book"></i>
       <span class="nav-text">Book Record</span>
       </a>
       </li>
