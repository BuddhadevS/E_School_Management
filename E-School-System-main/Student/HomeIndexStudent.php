...
.brand-logo {
  height: 100px;
  width: 100px;
  /* background: url("https://pxl-duracuk.terminalfour.net/fit-in/1600x900/prod01/prodbucket01/media/durham-university/colleges/ustinov-college/73080.jpg"); */
  margin: auto;
  border-radius: 50%;
  box-sizing: border-box;
...
<body>
  ...
  Welcome Student </h1>
    <nav class="main-menu">
       ...
       <li>                                   
       <a href="http://localhost/e-school%20system/Student/HomeIndexStudent.php">
       ...
       <li>                                 
       <a href="http://localhost/E-School System\Attendance\index.php">
       ...
       <li >
       <a href="http://localhost/e-school%20system/Marks.php">
            ...
            <div class="col-sm-6">
              ...
              <div class="card">
                <div class="cardbody">
                  ...
                  <p class="card-text"><?php echo ($_SESSION['dob']);?></p>
            ...
            <div class="col-sm-6">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo ($_SESSION['number']);?></p>
            ...
            <div class="col-sm-12 ">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo ($_SESSION['pid']);?></p>
